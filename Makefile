#############################################################################
# Makefile for building: gil-qt
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sun Jul 14 10:10:19 2013
# Project:  gil-qt.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe "USE_UPNP=- gil-qt.pro" -o Makefile gil-qt.pro
#############################################################################
...
Makefile: gil-qt.pro  ../Qt/4.8.4/mkspecs/win32-g++/qmake.conf ../Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) "USE_UPNP=- gil-qt.pro" -o Makefile gil-qt.pro

...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Tue 27. Aug 00:56:56 2013
# Project:  gil-qt.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe USE_UPNP=- -o Makefile gil-qt.pro
#############################################################################
...
Makefile: gil-qt.pro  c:/Qt/4.8.4/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile gil-qt.pro

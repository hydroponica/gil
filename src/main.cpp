...
uint256 hashGenesisBlock("0x9c99b474842364abf2ae6a86adcca3cd01ded2785c1470f13f324bdfa3b0ce7b");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Gil: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Gil Signed Message:\n";
...
static const int64 nTargetTimespan =  40 * 4; // Gil: 4 blocks
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // Gil: This fixes an issue where a 51% attack can change difficulty at will.
    ...
    /// debug print
    printf("GetNextWorkRequired RETGILET\n");
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Gil miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Gil", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9c99b474842364abf2ae6a86adcca3cd01ded2785c1470f13f324bdfa3b0ce7b");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Gil, A Currency for FF Fans";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1373643145;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 407581;

        if (fTestNet)
        {
            block.nTime    = 1373081649;             //test net not supported
            block.nNonce   = 407581;
        }
		...
		assert(block.hashMerkleRoot == uint256("0x14bce64d33d5a74193c3eb383cb4d1e21ff35b1f5aff06dbc5cb6b86ed5c092d"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Gild: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
